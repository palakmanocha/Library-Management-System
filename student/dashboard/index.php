    ...
    for ($i=0; $i < $n ; $i++) {
            ...
            $('#issue').append(`
              <div id = ".$details[$i]['Id']." class='b-con'>
                ...
                <br><br><br>
                  ...
                  <a href='issue.php?Book_Id=".$details[$i]['Book_Id']."'><button id='issue".$i."' type='button' name='button'>Issue</button></a>
                  <a href='buy.php?Book_Id=".$details[$i]['Book_Id']."'><button id='buy".$i."' type='button' name='button'>Buy</button></a>
      ...
      if($details[$i]['Available']<=0){
        echo "
          <script>
            $(document).ready(function(){
              $('#buy".$i."').attr('disabled','disabled');
              $('#issue".$i."').attr('disabled','disabled');
...
$issue = array();
    ...
    for ($i = 0; $i < $n1 ; $i++) {
      ...
      $one = date_create($issue[$i]['Due_Date']);
      $two = date_create($issue[$i]['Issue_Date']);
          ...
          $(document).ready(function(){
            $('#reissue').append(`
              <div id = 'i".$i."' class='b-con'>
                ...
                <br><br>
                <p>Title : ".$details[$i]['Title']."  <br> Author : ".$details[$i]['Author']." </p>
                <a href='reissue.php?Book_Id=".$issue[$i]['Book_Id']."'><button id='rbtn".$i."' type='button' name='button'>Re-Issue</button></a>
...
<html>
  <head>
    ...
    <link href="stud_dashboard.css" rel="stylesheet">
